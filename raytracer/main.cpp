...
int main () {
    std::string name_of_file = "/home/kkopnev/Documents/RayTracer/raytracer/tests/triangle/scene.obj";
    ...
    Camera camera{image_width, image_height, 90, {0.0, -2.0, 0.0}, {0.0, 0.0, 0.0}};
